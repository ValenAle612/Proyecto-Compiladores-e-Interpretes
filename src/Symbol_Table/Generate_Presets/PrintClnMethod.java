...
public class PrintClnMethod extends Method {

    public PrintClnMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
