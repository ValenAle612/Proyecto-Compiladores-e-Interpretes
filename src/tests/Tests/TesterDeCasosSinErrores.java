...
public class TesterDeCasosSinErrores {
    ...
    private static final String testFilesDirectoryPath = "resources/sinErrores_SynTest/";

    //TO-DO: el tipo de esta variable init tiene que ser la clase que tiene el main
