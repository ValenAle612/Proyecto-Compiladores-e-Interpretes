...
public class PrintBMethod extends Method {

    public PrintBMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
