...
public class ReadMethod extends Method {

    public ReadMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
    ...
    public void generate(){
        ...
        SymbolTable.generate("READ   ; read the integer ");
        SymbolTable.generate("PUSH 48");
        SymbolTable.generate("SUB");
        SymbolTable.generate("STORE 3");
        SymbolTable.generate("STOREFP");
        SymbolTable.generate("RET "+0+" ; No parameters");
    }
