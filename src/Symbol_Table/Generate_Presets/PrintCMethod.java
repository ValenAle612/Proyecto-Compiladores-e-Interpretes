...
public class PrintCMethod extends Method{

    public PrintCMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
