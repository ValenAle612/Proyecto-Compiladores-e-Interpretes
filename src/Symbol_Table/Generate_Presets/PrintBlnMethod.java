...
public class PrintBlnMethod extends Method {

    public PrintBlnMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
