...
public class PrintSMethod extends Method {

    public PrintSMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
