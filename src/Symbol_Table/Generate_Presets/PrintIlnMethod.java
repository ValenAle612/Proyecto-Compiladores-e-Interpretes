...
public class PrintIlnMethod extends Method {

    public PrintIlnMethod(HashMap<String, Parameter> parameters, ArrayList<Parameter> parameters_list, Token method_token,
